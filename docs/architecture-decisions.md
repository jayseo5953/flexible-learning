...
The repository root is the static learning framework. It contains the router, skills, templates, docs, hooks design, and package metadata.
...
- Learn mode blocks framework, profile, and curriculum edits.
